...
Crypto.create(name: Coinmarketcap.coin(1)["data"]["name"], description: "Bitcoin blah blah blah Bitcoin money Blah", logo: "404", symbol: Coinmarketcap.coin(1)["data"]["symbol"], value: Coinmarketcap.coin(1)["data"]["quotes"]["USD"]["price"], coinbase_id: 1 )
