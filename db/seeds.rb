...
Crypto.create(name: Coinmarketcap.coin(1027)["data"]["name"], description: "Ethereum blah blah blah Etherium money Blah", logo: "404", symbol: Coinmarketcap.coin(1027)["data"]["symbol"], value: Coinmarketcap.coin(1027)["data"]["quotes"]["USD"]["price"], coinbase_id: 1027 )
